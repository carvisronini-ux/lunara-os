...
export default function HomePage() {
  ...
  // Nyx-ის ლოგები და კოპირების სტატუსი
  ...
  useEffect(() => {
    ...
    // Nyx-ის შესაძლებლობების ივენთები
    ...
    osEngine.onEvent("OPPORTUNITY_APPROVED" as any, (event: any) => {
      ...
      if (opportunity && opportunity.status === "approved") {
        ...
        setTimeout(() => {
          ...
          // 📡 ავტომატურად გადაეცი Echo-ს დამტკიცებული ვარიანტები
          setTimeout(() => {
